      ...
      <h1 className="text-2xl font-medium text-amber-600">About</h1>
       ...
       <p>
        ...
        <p>
          ...
          <span className="text-2xl font-bold "><a href="https://github.com/AlbertAdekanye/IMDB-clone"> GitHub</a></span>
        </p>
        </p>
    </div>
  )
